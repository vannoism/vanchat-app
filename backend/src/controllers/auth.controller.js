...
export const logout = (req, res)=> {
    try {
        ...
        res.status(200).json({message: "Logged out is succesfully"})
    } catch (error) {
...
export const updateProfile = async (req, res) => {
    try {
        ...
        const updatedUser = await User.findByIdAndUpdate(userId, {profilePict:uploadResponse.secure_url}, {new:true});
